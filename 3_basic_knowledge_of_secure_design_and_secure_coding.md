...
========= ============================================ ===================================== 
高位      | 資産が被害にあった場合、組織または個人の   | Android OSのセキュリティモデルを破る、
          | 活動に致命的または壊滅的な影響をあたえる   | root権限を奪取した状態からの
          | もの                                       | 攻撃やAPKのdex部分を改造するといっ
          |                                            | た、高度な攻撃に対しても保護する。
          | 例）資産が被害にあった場合、当該組織       | 
          | が事業を継続できなくなるレベル             | UX等の他要素よりもセキュリティ確
          |                                            | 保を優先する
中位      | 資産が被害にあった場合、組織または個人の   | Android OSのセキュリティモデルを
          | 活動に重大な影響をあたえるもの             | 活用し、その範囲内で保護する
          |                                            |
          | 例）資産が被害にあった場合、当該組織の     | UX等の他要素よりもセキュリティ
          | 利益が悪化し、事業に影響を及ぼすレベル     | 確保を優先する
低位      | 資産が被害にあった場合、組織または個人の   | Android OSのセキュリティモデルを
          | 活動に限定的な影響をあたえるもの           | 活用し、その範囲内で保護する
          |                                            |
          | 例）資産が被害にあった場合、当該組織       | UX等の他要素とセキュリティを比
          | の利益に影響を与え得るが、他の要素により   | 較し、他要素を優先しても良い
          | 利益の補てんが可能なレベル                 |
========= ============================================ ===================================== 
```
