...
スマートフォンを安心して利用出来る社会へ <!-- Building a Secure Smartphone Society -->
----------------------------------------
...
常にベータ版でタイムリーなフィードバックを <!-- Timely Feedback on a Regular Basis Through the Beta Version -->
------------------------------------------
...
本文書の利用許諾 <!-- Usage Agreement of the Guidebook -->
----------------
...
2017年2月1日版からの訂正記事について <!-- Correction articles -->
------------------------------------
