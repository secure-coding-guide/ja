...
ガイド文書のスコープ <!-- The Scope of the Guidebook -->
--------------------
...
![](media/image5.svg){width="6.889763779527559in"
...
Androidセキュアコーディング関連書籍の紹介 <!-- Literature on Android Secure Coding -->
-----------------------------------------
...
サンプルコードのAndroid Studioへの取り込み手順 <!-- Steps to Install Sample Codes into Android Studio -->
----------------------------------------------
...
### サンプルプロジェクトを取り込む <!-- Installing the Sample Project -->
...
![](media/image6.svg){width="4.6875in" height="1.6666666666666667in"}
...
![](media/image7.svg){width="3.8645833333333335in"
...
![](media/image8.svg){width="5.458333333333333in"
