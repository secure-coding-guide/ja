...
Clipboardから情報漏洩する危険性<!-- x94c075c0 -->
-------------------------------
...
#### 文字列選択時のメニューからコピー・カットを削除する<!-- x884c98de -->
...
#### Viewの長押し(Long Click)を無効にする<!-- xf54eb680 -->
...
#### Viewに表示されている文字列のコピー・カットを無効にする (必須)<!-- x060b7251 -->
...
#### Clipboardに格納されている情報の操作<!-- x9b9f1409 -->
